...
type GoodsClient interface {
	...
	//轮播图
	BannerList(ctx context.Context, in *BannerListReq, opts ...grpc.CallOption) (*BannerListResponse, error)
...
func (c *goodsClient) BannerList(ctx context.Context, in *BannerListReq, opts ...grpc.CallOption) (*BannerListResponse, error) {
...
type GoodsServer interface {
	...
	//轮播图
	BannerList(context.Context, *BannerListReq) (*BannerListResponse, error)
...
func (UnimplementedGoodsServer) BannerList(context.Context, *BannerListReq) (*BannerListResponse, error) {
...
func _Goods_BannerList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoodsServer).BannerList(ctx, req.(*BannerListReq))
	}
	return interceptor(ctx, in, info, handler)
}
